...
def main():
    ...
    parser.add_argument('--output-dir', type=str, default='test_audio_recordings', help='Output directory for the recording files')
    ...
    try:
        with sd.InputStream(samplerate=args.samplerate,
            ...
            print(f"Device 1: [{card1_index}] {args.device1}")
            print(f"Device 2: [{card2_index}] {args.device2}")
            print('#' * 80)
            ...
            while elapsed_time < args.total_duration:
                ...
                overall_path = current_output_dir / filename

                total_channels = args.channels_per_device * 2

                with sf.SoundFile(overall_path, mode='w',
