...
# run the pretrain
python3 /path/to/code/animal2vec_train.py hydra.run.dir="outputs/my_pretrained_model" --config-dir=/path/to/code/configs/ --config-name animal2vec_base_pretrain_10s-2-1_5_sinc_38ms_mixup_pswish
